...
ATTACHMENT_DATASET_ID = "datasetId"
ATTACHMENT_RAW_DATASET_ID = "rawDatasetId"
ATTACHMENT_DERIVED_DATASET_ID = "derivedDatasetId"
ATTACHMENT_PROPOSAL_ID = "proposalId"

PROPERTIES_ATTACHMENT = {
    ATTACHMENT_ID: "ObjectID string (pattern: ^[a-fA-F\d]{24}$)",
    ATTACHMENT_CAPTION: "Attachment caption to show in catanie",
    ATTACHMENT_THUMBNAIL: "Contains a thumbnail preview in base64 encoded png format for a given dataset",
    ATTACHMENT_DATASET_ID: "string",
    ATTACHMENT_RAW_DATASET_ID: "string",
    ATTACHMENT_DERIVED_DATASET_ID: "string",
    ATTACHMENT_PROPOSAL_ID: "string",
    OWNER_GROUP: COMMON_PROPERTIES[OWNER_GROUP],
    ACCESS_GROUPS: COMMON_PROPERTIES[ACCESS_GROUPS]
}
