...
class ScicatIngestDatasetParser(ScicatParser):
    def __init__(self):
        ...
        self.add_argument("-n", "--nattachments", type=int, default=1, help="Number of image attachments to a dataset")
        self.add_argument("-t", "--thumbnailsize", type=int, default=150, help="Thumbnail size (default: 150px)")
        self.add_argument("-e", "--emptyadd", action='store_true', help="Also add empty datasets")